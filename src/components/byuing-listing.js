      ...
      <div className="byuing-listing-hero">
        <div className="byuing-listing-top">
          ...
          <div className="byuing-listing-state">
            <span className="byuing-listing-text01">{props.text5}</span>
          </div>
        </div>
        <div className="byuing-listing-bottom">
          <div className="byuing-listing-location">
            ...
            <span className="byuing-listing-text02">{props.text61}</span>
          </div>
        </div>
      </div>
      <div className="byuing-listing-container">
        <span className="byuing-listing-text03">{props.text}</span>
        <span className="byuing-listing-text04">{props.text1}</span>
        <span className="byuing-listing-text05">{props.text2}</span>
        <div className="byuing-listing-container1">
          <div className="byuing-listing-details">
            <svg
            ...
            <span className="byuing-listing-text06">{props.text4}</span>
            ...
            <span className="byuing-listing-text07">{props.text42}</span>
            ...
            <span className="byuing-listing-text08">{props.text41}</span>
          </div>
          <span className="byuing-listing-text09">{props.text3}</span>
        </div>
      </div>
    </div>
  )
